...
class ParkingSystem:
    ...
    def reserve_spot(self, spot_type: str, user_name: str = "Nepoznat") -> Dict:
        ...
        # QR kod sadrži URL koji vodi na scanner stranicu sa kodom
        qr_value = f"http://localhost:5000/scanner?code=Parking-{spot_type.upper()}-{self.reservation_counter}-{timestamp}"
